...
static const struct RegionMapLocation sRegionMapEntries_Johto[] = {
    ...
    [MAPSEC_MELEMELE_ISLAND]   = { 26, 12, 1, 1, COMPOUND_STRING("MELEMELE ISLAND") },
    [MAPSEC_AKALA_ISLAND]     = { 27, 11, 1, 1, COMPOUND_STRING("AKALA ISLAND") },
    [MAPSEC_ULAULA_ISLAND]    = { 27, 12, 1, 1, COMPOUND_STRING("ULA'ULA ISLAND") },
    [MAPSEC_PONI_ISLAND]      = { 25, 12, 1, 1, COMPOUND_STRING("PONI ISLAND") },
    [MAPSEC_ALOLA_OCEAN]      = { 25, 13, 1, 1, COMPOUND_STRING("ALOLA OCEAN") },
    [MAPSEC_AKALA_CAVE]       = { 27, 14, 1, 1, COMPOUND_STRING("AKALA CAVE") },
    [MAPSEC_AKALA_FOREST]     = { 27, 13, 1, 1, COMPOUND_STRING("AKALA FOREST") },
    [MAPSEC_PONI_CAVE]        = { 25, 14, 1, 1, COMPOUND_STRING("PONI CAVE") },
    [MAPSEC_ULAULA_CAVE]     = { 26, 14, 1, 1, COMPOUND_STRING("ULA'ULA CAVE") },
    [MAPSEC_ULAULA_CAVE_2]   = { 26, 13, 1, 1, COMPOUND_STRING("ULA'ULA CAVE") },
};
#endif
