...
static const struct RegionMapLocation sRegionMapEntries_Johto[] = {
    ...
    [MAPSEC_MELEMELE_ISLAND]   = { 0,  0, 1, 1, COMPOUND_STRING("MELEMELE ISLAND") },
    [MAPSEC_AKALA_ISLAND]     = { 0,  0, 1, 1, COMPOUND_STRING("AKALA ISLAND") },
    [MAPSEC_ULAULA_ISLAND]    = { 0,  0, 1, 1, COMPOUND_STRING("ULA'ULA ISLAND") },
    [MAPSEC_PONI_ISLAND]      = { 0,  0, 1, 1, COMPOUND_STRING("PONI ISLAND")},
    [MAPSEC_ALOLA_OCEAN]      = { 0,  0, 1, 1, COMPOUND_STRING("ALOLA OCEAN")},
};
#endif
...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_MELEMELE_ISLAND] = {MAP_GROUP(MAP_ALOLA_ISLAND_MELEMELE_HNS), MAP_NUM(MAP_ALOLA_ISLAND_MELEMELE_HNS), HEAL_LOCATION_ALOLA_ISLAND_MELEMELE_HNS},
    [MAPSEC_AKALA_ISLAND] = {MAP_GROUP(MAP_ALOLA_ISLAND_MELEMELE_HNS), MAP_NUM(MAP_ALOLA_ISLAND_MELEMELE_HNS), HEAL_LOCATION_ALOLA_ISLAND_MELEMELE_HNS},
    [MAPSEC_ULAULA_ISLAND] = {MAP_GROUP(MAP_ALOLA_ISLAND_MELEMELE_HNS), MAP_NUM(MAP_ALOLA_ISLAND_MELEMELE_HNS), HEAL_LOCATION_ALOLA_ISLAND_MELEMELE_HNS},
    [MAPSEC_PONI_ISLAND] = {MAP_GROUP(MAP_ALOLA_ISLAND_MELEMELE_HNS), MAP_NUM(MAP_ALOLA_ISLAND_MELEMELE_HNS), HEAL_LOCATION_ALOLA_ISLAND_MELEMELE_HNS},
