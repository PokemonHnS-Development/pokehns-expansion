...
#define FLAG_NEWSINJOH_NPC_TRADE_COMPLETED          (HNS_EXTENDED_CONTENT_START + 14)
#define FLAG_VISITED_NEWSINJOH                      (HNS_EXTENDED_CONTENT_START + 15)
#define FLAG_NEWSINJOH_HEATROCK_GOT                 (HNS_EXTENDED_CONTENT_START + 16)
#define FLAG_NEWSINJOH_HIDDENITEM1                  (HNS_EXTENDED_CONTENT_START + 17)
#define FLAG_NEWSINJOH_HIDDENITEM2                  (HNS_EXTENDED_CONTENT_START + 18)
#define FLAG_NEWSINJOH_HIDDENITEM3                  (HNS_EXTENDED_CONTENT_START + 19)
#define FLAG_NEWSINJOH_HAUNTEDHOUSE_DOORLOCK2       (HNS_EXTENDED_CONTENT_START + 20)
#define FLAG_NEWSINJOH_ITEM_DUSKBALL                (HNS_EXTENDED_CONTENT_START + 21)
#define FLAG_VISITED_NEW_SINJOH                     (HNS_EXTENDED_CONTENT_START + 22)
#define FLAG_NEWSINJOH_POKEMONCENTER_ARTIST_GIFT    (HNS_EXTENDED_CONTENT_START + 23)
#define FLAG_NEWSINJOH_HAUNTEDHOUSE_DOORLOCK        (HNS_EXTENDED_CONTENT_START + 24)
#define FLAG_NEWSINJOH_HAUNTEDHOUSE_KEY1            (HNS_EXTENDED_CONTENT_START + 25)
#define FLAG_NEWSINJOH_HAUNTEDHOUSE_KEY2            (HNS_EXTENDED_CONTENT_START + 26)
#define FLAG_NEWSINJOH_HAUNTEDHOUSE_KEY3            (HNS_EXTENDED_CONTENT_START + 27)
#define FLAG_NEWSINJOH_HAUNTEDHOUSE_GRAVELIGHT_NORTH (HNS_EXTENDED_CONTENT_START + 28)
#define FLAG_NEWSINJOH_HAUNTEDHOUSE_GRAVELIGHT_WEST (HNS_EXTENDED_CONTENT_START + 29)
#define FLAG_NEWSINJOH_HAUNTEDHOUSE_GRAVELIGHT_EAST (HNS_EXTENDED_CONTENT_START + 30)
#define FLAG_NEWSINJOH_HAUNTEDHOUSE_GRAVELIGHT_SOUTH (HNS_EXTENDED_CONTENT_START + 31)
#define FLAG_NEWSINJOH_HAUNTEDHOUSE_FROSLASS        (HNS_EXTENDED_CONTENT_START + 32)
#define FLAG_NEWSINJOH_HAUNTEDHOUSE_FROSLASS_CAUGHT (HNS_EXTENDED_CONTENT_START + 33)
#define FLAG_NEWSINJOH_hAUNTEDHOUSE_KEYSUNLOCKED    (HNS_EXTENDED_CONTENT_START + 34)
#define FLAG_NEWSINJOH_HAUNTEDHOUSE_STAIRS          (HNS_EXTENDED_CONTENT_START + 35)
#define FLAG_NEWSINJOH_HAUNTEDHOUSE_GRAVELIGHT_N    (HNS_EXTENDED_CONTENT_START + 36)
#define FLAG_NEWSINJOH_HAUNTEDHOUSE_GRAVELIGHT_W    (HNS_EXTENDED_CONTENT_START + 37)
#define FLAG_NEWSINJOH_HAUNTEDHOUSE_GRAVELIGHT_E    (HNS_EXTENDED_CONTENT_START + 38)
#define FLAG_NEWSINJOH_HAUNTEDHOUSE_GRAVELIGHT_S    (HNS_EXTENDED_CONTENT_START + 39)
#define FLAG_SNOWSWEPT_BOULDERMOVE                  (HNS_EXTENDED_CONTENT_START + 40)
#define FLAG_SNOWSWEPT_HIDDEN_ICYROCK               (HNS_EXTENDED_CONTENT_START + 41)
#define FLAG_SNOWSWEPT_ITEM_NEVERMELTICE            (HNS_EXTENDED_CONTENT_START + 42)
#define FLAG_SNOWSWEPT_ITEM_ULTRABALL               (HNS_EXTENDED_CONTENT_START + 43)
#define FLAG_SNOWSWEPTB_SPLASHPLATE                (HNS_EXTENDED_CONTENT_START + 44)
#define FLAG_SNOWSWEPTB_HIDDEN_ITEM2                 (HNS_EXTENDED_CONTENT_START + 45)
#define FLAG_SNOWSWEPTB_ITEM_MAXREVIVE                    (HNS_EXTENDED_CONTENT_START + 46)
#define FLAG_SNOWSWEPTB_ITEM_LAVACOOKIE                    (HNS_EXTENDED_CONTENT_START + 47)
#define FLAG_SNOWSWEPTB_HIDDEN_ITEM1                    (HNS_EXTENDED_CONTENT_START + 48)
#define FLAG_ROUTE_49_KIMONOGIRL                    (HNS_EXTENDED_CONTENT_START + 49)
#define FLAG_ROUTE_49_MINDPLATE                    (HNS_EXTENDED_CONTENT_START + 50)
#define FLAG_ROUTE_49_ITEM_STARDUST                    (HNS_EXTENDED_CONTENT_START + 51)
#define FLAG_ROUTE_49_ITEM_LURE                    (HNS_EXTENDED_CONTENT_START + 52)
#define FLAG_ROUTE_49_HIDDENITEM_ICESTONE                    (HNS_EXTENDED_CONTENT_START + 53)
#define FLAG_ROUTE_49_HIDDENITEM_ULTRABALL                   (HNS_EXTENDED_CONTENT_START + 54)
#define FLAG_ROUTE_49_HIDDENITEM_KINGSROCK                    (HNS_EXTENDED_CONTENT_START + 55)
#define FLAG_SINJOHRUINS_STEVENSTONE                    (HNS_EXTENDED_CONTENT_START + 56)
#define FLAG_SINJOHRUINS_HOUSE1_STEVENSTONE_INTRO_YAPPINGDONE                    (HNS_EXTENDED_CONTENT_START + 57)
#define FLAG_SINJOHRUINS_HOUSE1_STEVEN2                   (HNS_EXTENDED_CONTENT_START + 58)
#define FLAG_FOUGHT_NOBLE_URSALUNA                    (HNS_EXTENDED_CONTENT_START + 59)
#define FLAG_FOUGHT_NOBLE_KLEAVOR                   (HNS_EXTENDED_CONTENT_START + 60)
#define FLAG_FOUGHT_NOBLE_ARCANINE                    (HNS_EXTENDED_CONTENT_START + 61)
#define FLAG_FOUGHT_NOBLE_ELECTRODE                    (HNS_EXTENDED_CONTENT_START + 62)
#define FLAG_FOUGHT_NOBLE_SNEASLER                    (HNS_EXTENDED_CONTENT_START + 63)
#define FLAG_FOUGHT_NOBLE_WYRDEER                    (HNS_EXTENDED_CONTENT_START + 64)
#define FLAG_NOBLES_UNLOCKED                    (HNS_EXTENDED_CONTENT_START + 65)
#define FLAG_NEWSINJOH_HOUSE1_ELIZABETH_FIRSTMET                    (HNS_EXTENDED_CONTENT_START + 66)
#define FLAG_NEWSINJOH_HOUSE1_ELIZABETH_GAVEWOOPER                    (HNS_EXTENDED_CONTENT_START + 67)
#define FLAG_NEWSINJOH_HOUSE1_SKYPLATE                    (HNS_EXTENDED_CONTENT_START + 68)
#define FLAG_NEWSINJOH_KIMONOGIRLGRASS                    (HNS_EXTENDED_CONTENT_START + 69)
#define FLAG_NEWSINJOH_KIMONOGIRLICE                    (HNS_EXTENDED_CONTENT_START + 70)
#define FLAG_NEWSINJOH_KIMONOGIRLFAIRY                    (HNS_EXTENDED_CONTENT_START + 71)
#define FLAG_ROUTE50GATE_BLACKBELTREX_FISTPLATE                    (HNS_EXTENDED_CONTENT_START + 72)
#define FLAF_REMOVE_REX_AND_HERACROSS                    (HNS_EXTENDED_CONTENT_START + 73)
#define FLAG_DEFEATED_CHANNELERYOUMU                   (HNS_EXTENDED_CONTENT_START + 74)
#define FLAG_ROUTE50_CHANNELER_YOUMU                    (HNS_EXTENDED_CONTENT_START + 75)
#define FLAG_NEWSINJOH_ITEMBALL2                    (HNS_EXTENDED_CONTENT_START + 76)
#define FLAG_ROUTE50_HIDDENITEM_1                    (HNS_EXTENDED_CONTENT_START + 77)
#define FLAG_ROUTE50_ITEMBALL_1                    (HNS_EXTENDED_CONTENT_START + 78)
#define FLAG_ROUTE50_ITEMBALL_2                   (HNS_EXTENDED_CONTENT_START + 79)
#define FLAG_ROUTE50_HIDDENITEM_2                    (HNS_EXTENDED_CONTENT_START + 80)
#define FLAG_ROUTE50_HIDDENITEM_3                    (HNS_EXTENDED_CONTENT_START + 81)
#define FLAG_SINJOHRUINS_ARCEUS_STAIRS                    (HNS_EXTENDED_CONTENT_START + 82)
#define FLAG_SINJOHRUINS_STEVENSTONE2                    (HNS_EXTENDED_CONTENT_START + 83)
#define FLAG_SINJOHRUINS_STEVENSTONE_PART1                    (HNS_EXTENDED_CONTENT_START + 84)
#define FLAG_SINJOHRUINS_STEVENSTONE_PART2                    (HNS_EXTENDED_CONTENT_START + 85)
#define FLAG_SINJOHRUINS_ARCEUS                    (HNS_EXTENDED_CONTENT_START + 86)
#define FLAG_SINJOHRUINS_ARCEUS_APPEARS                   (HNS_EXTENDED_CONTENT_START + 87)
#define FLAG_SINJOHRUINS_ARCEUS_DEFEATED                   (HNS_EXTENDED_CONTENT_START + 88)
#define FLAG_HIDELILY1                    (HNS_EXTENDED_CONTENT_START + 89)
#define FLAG_HIDELILY2                    (HNS_EXTENDED_CONTENT_START + 90)
#define FLAG_ROUTE50_LILY_GIFT                    (HNS_EXTENDED_CONTENT_START + 91)
#define FLAG_SINJOHRUINS_REGIROCK                   (HNS_EXTENDED_CONTENT_START + 92)
#define FLAG_SINJOHRUINS_REGIDRAGO                    (HNS_EXTENDED_CONTENT_START + 93)
#define FLAG_SINJOHRUINS_REGICE                    (HNS_EXTENDED_CONTENT_START + 94)
#define FLAG_SINJOHRUINS_REGISTEEL                    (HNS_EXTENDED_CONTENT_START + 95)
#define FLAG_SINJOHRUINS_REGIELEKI                    (HNS_EXTENDED_CONTENT_START + 96)
#define FLAG_SINJOHRUINS_REGIGIGAS                    (HNS_EXTENDED_CONTENT_START + 97)
#define FLAG_MT_SILVER_1F_HIDE_SCIENTIST                    (HNS_EXTENDED_CONTENT_START + 98)

#define FLAG_HIDE_MT_SILVER_2F_AZURE_FLUTE                    (HNS_EXTENDED_CONTENT_START + 99)
