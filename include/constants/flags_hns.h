...
#define FLAG_NEWSINJOH_HAUNTEDHOUSE_GRAVE1          (HNS_EXTENDED_CONTENT_START + 14)
#define FLAG_NEWSINJOH_HAUNTEDHOUSE_GRAVE2          (HNS_EXTENDED_CONTENT_START + 15)
#define FLAG_NEWSINJOH_HAUNTEDHOUSE_GRAVE3          (HNS_EXTENDED_CONTENT_START + 16)
#define FLAG_NEWSINJOH_HAUNTEDHOUSE_GRAVE4          (HNS_EXTENDED_CONTENT_START + 17)
#define FLAG_NEWSINJOH_HAUNTEDHOUSE_FROSLASS_SPAWN  (HNS_EXTENDED_CONTENT_START + 18)
