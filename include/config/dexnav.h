...
// Flag/var defines
#define DN_FLAG_SEARCHING             FLAG_EXTENDED_CONTENT_0 // Searching for mon
#define DN_FLAG_DEXNAV_GET            FLAG_EXTENDED_CONTENT_1 // DexNav shows in start menu
#define DN_FLAG_DETECTOR_MODE         FLAG_EXTENDED_CONTENT_2 // Allow player to find hidden mons
#define DN_VAR_SPECIES                VAR_UNUSED_HNS_0x40A7 // Registered DexNav species
#define DN_VAR_STEP_COUNTER           VAR_UNUSED_HNS_0x40A8 // Steps for finding hidden pokemon
